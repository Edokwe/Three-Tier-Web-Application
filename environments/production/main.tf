...
module "vpc" {
  ...
  vpc_name     = "high-availability-app-vpc-prod"
  ...
  single_nat_gateway   = false # Use NAT Gateway per AZ for High Availability in Production
  enable_flow_logs     = true
  flow_logs_retention  = 30 # Longer retention for production
}
